...
public final class LtiConstants {
     ...
     *
     * <p>
     * This parameter name is the parameter used in ContentItemSelectionMessage and will contain the
     * user's selections of content items that they wish to add to the consumer.
     * The parameter will be a string value that contains a json structure representative of their
     * content selections.
     */
