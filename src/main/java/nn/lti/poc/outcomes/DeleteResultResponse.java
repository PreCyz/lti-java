...
public class DeleteResultResponse implements OutcomesMessage {
    ...
    public DeleteResultResponse(String messageIdentifier, ResponseCodeMajor responseCodeMajor, ResponseSeverity responseSeverity, String description, String messageRefIdentifier) {
